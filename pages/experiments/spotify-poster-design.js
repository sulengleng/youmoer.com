    ...
    return (
        <body className="selection:bg-red-600 selection:text-white">
            <div className="border-8 border-red-600">
                ...
                <div className="px-6 py-2 mx-auto max-w-[90%] justify-center text-center text-sm text-gray-500 bg-repeat" style="background-image: url(https://s2.loli.net/2022/12/07/3MBKFxyaXtjNrGh.png)">
