        ...
        <motion.div
            ...
            <ContentWrapper className="gap-6 columns-3 space-y-6 pt-6">
                ...
                >
                    ...
                    loading="lazy"
                    />
                    <div className="font-mono text-xs absolute bottom-[4%] left-[4%] inline-flex bg-white/90 bg-opacity-60 bg-clip-padding backdrop-blur rounded-[10px] px-2 py-px items-center dark:text-black">
