        ...
        >
            <motion.div className="flex md:flex-row flex-col space-y-4">
                ...
                <div className="basis-3/7">
                    <div className="flex flex-col bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-black dark:to-[#434343] max-w-[90%] w-fit md:max-w-fit h-52 mx-auto rounded-lg">
                        <div className="flex">
