                ...
                <div className="flex md:flex-row flex-col space-y-4">
                    <div className="basis-2/7">
                        <div className="jike ml-4 mt-4">
                            <div className="flex flex-col rounded-lg bg-gray-100 dark:bg-black shadow-md">
                        ...
                        <div className="ml-4 mt-4">
                            ...
                            <div className="player select-none">
                                <div className="shadow-md mx-auto max-w-full overflow-hidden rounded-xl bg-gradient-to-r from-black via-[#083517] to-[#065321] shadow-md md:max-w-sm">
                                    <div className="flex">
                        ...
                        <div
                            className="pt-6 bg-gray-100 md:rounded-lg shadow-md dark:bg-gray-900 mt-4 ml-4 overflow-y-scroll h-96"
                        >
