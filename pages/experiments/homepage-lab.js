            ...
            <motion.div className="flex md:flex-row flex-col space-y-4">
                ...
                <div className="basis-2/7">
                    ...
                    >
                        ...
                        >
                            <div className="-mt-2 text-clip max-h-[100px] overflow-clip text-9xl drop-shadow-md text-gray-400 dark:text-white">₿</div>
                            <div className="mt-10 ml-12 flex -space-x-3">
