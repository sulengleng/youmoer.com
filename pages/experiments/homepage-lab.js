                ...
                <div className="flex md:flex-row flex-col space-y-4">
                    <div className="basis-2/7">
                        ...
                        <div className="md:ml-4 mt-4 max-w-[90%] md:max-w-full mx-auto">
                            ...
                            <div className="player select-none">
                                <div className="drop-shadow-md mx-auto max-w-full overflow-hidden rounded-xl bg-gradient-to-tr from-[#fdfbfb] to-[#ebedee] dark:bg-gradient-to-br from-black via-[#083517] to-[#065321] shadow-md md:max-w-sm">
                                    <div className="flex">
                        ...
                        <div
                            className="relative max-w-[90%] md:max-w-full mx-auto bg-gray-100 rounded-lg drop-shadow-md dark:bg-gray-900 mt-4 md:ml-4 overflow-y-scroll h-96"
                        >
                            <div className="bg-gray-200/30 dark:bg-gray-800/30 backdrop-blur-lg h-6 rounded-t-lg sticky top-0"></div>
                    ...
                    <div className="basis-2/7">
                        <div className="rounded-lg aspect-square md:mr-4 max-w-[90%] md:max-w-full mx-auto">
                            <div className="rounded-lg bg-light-map dark:bg-dark-map h-80 max-w-full bg-cover bg-center"></div>
                        </div>
                    </div>
                </div>
            </motion.div>
