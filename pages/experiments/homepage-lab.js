...
export default function Home() {
    ...
    <body className="selection:bg-[#3b818c]">
        ...
        <motion.div
            ...
            >
                <div className="container mt-8 max-w-[80%] mx-auto md:max-w-[70%] h-80 overflow-x-scroll overflow-x-hidden scroll-pl-6 scroll-smooth snap-x flex flex-row space-x-10 items-center bg-gradient-to-r from-gray-700 to-gray-900 rounded-md [-ms-overflow-style: none] [scrollbar-width: none]">
                    ...
                    <img className="rounded-lg max-h-56 snap-center shadow-md" src="https://files.catbox.moe/ibe9j9.png" alt="music"></img>
                </div>
            </motion.div>
        </div>
    </body>
