...
export default function Home() {
    ...
    <body className="selection:bg-[#3b818c]">
        ...
        <motion.div
            ...
            >
                <div className="container mt-8 max-w-[80%] mx-auto md:max-w-[40%] h-96 overflow-x-scroll overflow-x-hidden scroll-pl-6 scroll-smooth snap-x flex flex-row space-x-10 items-center bg-gradient-to-r from-gray-700 to-gray-900 rounded-md">
