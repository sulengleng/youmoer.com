...
export default function Home() {
    ...
    <body className="selection:bg-[#3b818c]">
        ...
        <motion.div
            ...
            >
                <div className="container max-w-[80%] mx-auto md:max-w-[70%] h-80 overflow-x-scroll overflow-x-hidden scroll-smooth snap-x flex flex-row space-x-10 items-center bg-gradient-to-r from-red-500 to-purple-700 rounded-md">
