            ...
            >
                <div className="flex md:flex-row flex-col space-y-4">
                    <div className="basis-2/7">
                        ...
                        <div
                            className="relative max-w-[90%] md:max-w-full mx-auto bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-black dark:to-[#434343] rounded-lg drop-shadow-md mt-4 md:ml-4 overflow-y-scroll h-96"
                        >
