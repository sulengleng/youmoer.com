        ...
        >
            <motion.div className="flex md:flex-row flex-col space-y-4">
                ...
                <div className="basis-3/7">
                    <div className="flex flex-col bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-black dark:to-[#434343] max-w-[90%] w-[90%] md:w-max md:max-w-fit h-52 mx-auto rounded-lg">
                        <div className="flex">
                            <div className="bg-camera-left bg-cover rounded-3xl h-28 w-28 ml-10 mr-10 mt-6"></div>
                            ...
                            <div className="bg-camera-right bg-cover rounded-3xl h-28 w-28 mr-10 ml-10 mt-6"></div>
                        </div>
                        <marquee className="text-lg font-semibold mx-auto w-44">滑动照片查看更多~</marquee>
                    </div>
