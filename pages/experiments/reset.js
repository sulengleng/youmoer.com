            ...
            <div className="flex flex-col md:grid md:grid-cols-4 gap-4 min-w-screen mt-4 mx-4 ">
                ...
                <div className="w-full h-44 rounded-xl col-span-2 flex flex-row gap-4">
                    <div className="w-full md:w-2/3 h-44 relative flex flex-col rounded-xl bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-black dark:via-[#2e2e2e] dark:to-[#434343]">
                        <a className="mt-4 ml-4 text-lg font-semibold">最近在读 - 潮汐图</a>
                        <p className="mt-2 ml-4 text-xs max-w-xs">后来他说：“会传染。” 我说：“什么会传染？ 他说：“出海病。”
                    ...
                    <div className="w-full md:w-1/3 h-44 rounded-xl bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-black dark:via-[#2e2e2e] dark:to-[#434343]">
                        <img className="mx-auto my-auto mt-4 h-auto md:h-[85%] w-32 md:w-auto rounded-lg" src="https://s2.loli.net/2023/01/17/7lzrw29VK4SIokB.png" alt="book cover"></img>
                    </div>
                </div>
