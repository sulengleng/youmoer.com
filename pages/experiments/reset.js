                                    ...
                                    {isPlaying ? (
                                        <div className="flex">
                                          <span className="flex h-3 w-3">
                                            ...
                                            <div className="w-[88px] xl:w-28 ml-2 mb-1 text-xs xl:text-sm uppercase leading-3 dark:text-white break-normal">now playing</div>
                                        </div>
                                    ) : (
                                        <div className="flex">
                                          <span className="flex h-3 w-3">
                                            ...
                                            <div className="w-[88px] xl:w-28 ml-2 mb-1 text-xs xl:text-sm uppercase leading-3 dark:text-white break-normal">not playing</div>
                                        </div>
                                    )}
