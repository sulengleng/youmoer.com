                                    ...
                                    {isPlaying ? (
                                        <div className="flex">
                                          <span className="flex h-3 w-3 mt-1">
                                            ...
                                            <div className="w-40 ml-2 mb-1 text-xs xl:text-sm uppercase leading-3 dark:text-white break-normal">now playing</div>
                                        </div>
                                    ) : (
                                        <div className="flex">
                                          <span className="flex h-3 w-3 mt-1">
                                            ...
                                            <div className="w-40 ml-2 mb-1 text-xs xl:text-sm uppercase leading-3 dark:text-white break-normal">not playing</div>
                                        </div>
                                    )}
