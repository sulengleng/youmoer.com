    ...
    return (
        <motion.body className="selection:bg-[#3b818c]">
            ...
            <div className="flex flex-col md:grid md:grid-cols-4 gap-4 min-w-screen mt-4 mx-4 ">
                <div className="w-full h-72 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700 rounded-xl relative">
                ...
                <div className="w-full h-40 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700 rounded-xl flex flex-col relative">
                ...
                <div className="w-full h-40 md:h-56 flex flex-row md:flex-col bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700 rounded-xl">
                    <motion.div
                ...
                <div className="w-full h-32 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700 rounded-xl">
                ...
                <div className="w-full h-72 md:h-108 relative flex flex-col bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700 rounded-xl md:-mt-16">
                ...
                <div className="w-full h-40 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700 rounded-xl md:-mt-64"></div>
                <div className="w-full h-44 rounded-xl col-span-2 flex flex-row gap-4">
                    <div className="w-full md:w-2/3 h-40 md:h-44 relative flex flex-col rounded-xl bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700">
                        ...
                        <div className="absolute bottom-3 right-3 md:right-8 xl:right-12 flex flex-row">
                            <a className="text-xs font-semibold">林棹</a>
                            <a className="ml-2 text-xs">潮汐图</a>
                        </div>
                    </div>
                    <div className="w-1/3 h-40 md:h-44 rounded-xl bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700">
                ...
                <div className="w-full h-44 relative flex flex-col bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700 rounded-xl">
                ...
                <div className="w-full h-64 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-stone-500 dark:to-stone-700 rounded-xl md:-mt-68">
