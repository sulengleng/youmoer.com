          ...
          <ContentWrapper width="700px" className="ml-auto mb-4 sm:text-left">
              ...
              <div className="py-0 md:py-5 mt-5 md:mt-0">
                  <details className="group max-w-[625px] mx-auto">
                      ...
                      <div className="mx-4 grid grid-cols-3 lg:grid-cols-5 my-6 md:my-4 md:justify-center gap-5 md:gap-10 !max-w-[260px] md:!max-w-[580px] h-0 md:h-fit hidden md:visible">
                          {IMAGES?.map((item) => (
                              <div
                                  key={item.src}
                                  className={clsx(
                                      item?.className,
                                      "hidden md:visible relative border p-[4px] max-w-[110px] md:max-w-fit shadow-[0_0_32px_rgba(0,0,0,0.1)] rounded-[12px] dark:border-gray-700"
                                  )}
                              >
                                  <img
                                      src={item?.src}
