          ...
          <ContentWrapper width="700px" className="ml-auto mb-4 sm:text-left">
              ...
              <div className="py-0 md:py-5 mt-5 md:mt-0">
                  <details className="group max-w-[625px] mx-auto">
                      ...
                      <div className="mx-4 grid grid-cols-3 lg:grid-cols-5 my-6 md:my-4 md:justify-center gap-5 md:gap-10 !max-w-[260px] md:!max-w-[580px] hidden h-0 md:h-fit md:visible">
                          {IMAGES?.map((item) => (
                              <div
                                  key={item.src}
                                  className={clsx(
