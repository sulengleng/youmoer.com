        ...
        <h2 className="mb-12 mt-12 md:mx-36 text-3xl font-black md:text-4xl dark:text-white">仿生人夜游船(2022批次)使用手册</h2>
                      ...
                      <div className="mx-4 grid grid-cols-3 lg:grid-cols-5 my-0 md:my-4 md:justify-center gap-5 md:gap-10 !max-w-[260px] md:!max-w-[580px] h-0 md:h-fit xl:gap-24">
                          {ALBUMS?.map((item) => (
                              <div
                                  ...
                                  className={clsx(
                                      item?.className,
                                      "h-0 md:h-fit relative border-0 p-[4px] max-w-[110px] md:max-w-fit shadow-[0_0_32px_rgba(0,0,0,0.1)] rounded-full md:border md:dark:border-gray-700"
                                  )}
                              >
                                  <img
                                      src={item?.src}
                              ...
                              aria-labelledby="modal-title" role="dialog" aria-modal="true" id="modal">
                                  <div className="fixed inset-0 z-10 overflow-y-auto">
                                      <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                                          ...
                                          <div
                                          className="relative mb-16 sm:mb-0 scale-90 transform overflow-hidden rounded-lg bg-white dark:bg-gray-900/80 text-left opacity-0 shadow-xl transition-all duration-300 group-target:scale-100 group-target:opacity-100 sm:my-8 sm:w-full sm:max-w-lg">
          ...
          <ContentWrapper width="700px" className="ml-auto mb-4 sm:text-left">
              ...
              <div className="mt-4 prose prose-gray dark:prose-zinc dark:text-gray-200 mx-auto lg:prose-lg">
                  <p>
                      ...
                      今年很多充满戏剧性的经历使我更好的审视自己的想法，但是取而代之，很多纯粹的快乐从我的脑中消失了。
                  </p>
                  <p>
                      现在遇到事都会下意识的深度思考一下，然后做了很多无可奈何的决策。2023 年我给自己设置的学习主题是：”如何在限制下做出正确的决策“，
                      以此来应对新的一年遇到的各种挑战。
                  </p>
                  <p>
                      最后主大家新年快乐，保持幸福、健康和动力，好好的享受新的一年。
                  </p>
              </div>
          </ContentWrapper>
          <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black z-0">
              <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
                  <div
                      className="absolute inset-auto right-1/2 h-56 w-[30rem] bg-gradient-conic from-pink-500 via-black to-transparent text-white [--conic-position:from_70deg_at_center_top]"></div>
                  <div
                      className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-black to-pink-500 text-white [--conic-position:from_290deg_at_center_top]"></div>
                  ...
                  <div
                      className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-pink-400 blur-2xl"></div>
                  <div
                      className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-pink-400 blur-sm"></div>
