                              ...
                              aria-labelledby="modal-title" role="dialog" aria-modal="true" id="modal">
                                  <div className="fixed inset-0 z-10 overflow-y-auto">
                                      <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                                          ...
                                          <div
                                          className="relative mb-16 sm:mb-0 scale-90 transform overflow-hidden rounded-lg bg-white dark:bg-gray-900/60 text-left opacity-0 shadow-xl transition-all duration-300 group-target:scale-100 group-target:opacity-100 sm:my-8 sm:w-full sm:max-w-lg">
                                              <div className="bg-white dark:bg-gray-900/60 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
