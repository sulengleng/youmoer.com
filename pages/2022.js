        ...
        <h2 className="mb-12 mt-12 md:mx-36 text-3xl font-black md:text-4xl dark:text-white">仿生人夜游船(2022批次)使用手册</h2>
          ...
          <ContentWrapper width="700px" className="ml-auto mb-4 sm:text-left">
              ...
              >
                  <div className="flex gap-1 md:gap-6 mt-2 md:mt-4">
                      ...
                      <span className="absolute top-6 md:top-8 left-8 bg-[#eeeeee] dark:bg-[#735ed2] rounded-xl -rotate-3 h-6 w-6 md:h-14 md:w-14 z-0 transition-all duration-300 group-hover:scale-[70]"></span>
          ...
          <ContentWrapper width="700px" className="ml-auto mb-4 sm:text-left">
              ...
              <div className="mt-4 prose prose-gray dark:prose-zinc dark:text-gray-200 mx-auto lg:prose-lg">
                  ...
                  <p>
                      反思的话也不多说了，最后祝大家新年快乐，保持幸福、健康和动力，好好的享受新的一年。
                  </p>
              </div>
          </ContentWrapper>
          <ContentWrapper
          ...
          <iframe name="footer" src="https://app.notioncomments.com/embed/11e8c53d-ed56-46ca-8382-151b1f501f6d" className="w-[700px] h-auto mx-auto my-8"></iframe>
      </article>
    </>
  );
}
