            ...
            <div className="max-w-[90%] md:max-w-[95%] mx-auto mt-4">
                ...
                <div className="flex md:flex-row flex-col gap-x-4">
                    <div className="mt-8 w-full h-auto rounded-lg bg-[#38e8be] relative selection:bg-[#5200ff] selection:text-white">
                        ...
                        <h1 className="absolute z-0 bottom-16 -right-14 text-9xl font-extrabold md:font-black font-thunder uppercase text-white transform -rotate-90 mix-blend-overlay">Week</h1>
                    </div>
                    <div className="mt-8 w-full h-auto rounded-lg bg-[#e8b1d2] relative selection:bg-[#3d70fa] selection:text-black">
                        ...
                        <h1 className="absolute z-0 overflow-hidden bottom-40 -right-48 md:-right-36 text-9xl font-black font-thunder uppercase text-white transform -rotate-90 mix-blend-overlay">Highlight</h1>
                    </div>
