            ...
            <div className="max-w-[90%] max-w-[80%] mx-auto mt-4">
                ...
                <div className="flex md:flex-row flex-col gap-x-4">
                    <div className="mt-8 w-full h-auto rounded-lg bg-[#38e8be] relative selection:bg-[#5200ff]">
                        ...
                        <h1 className="absolute z-0 bottom-10 -right-2 text-8xl font-black uppercase text-white transform -rotate-90 mix-blend-overlay">Week</h1>
                    </div>
                    <div className="mt-8 w-full h-auto rounded-lg bg-[#e8b1d2] relative selection:bg-[#3d70fa]">
                        ...
                        <h1 className="absolute z-0 bottom-8 -right-6 text-8xl font-black uppercase text-white transform -rotate-90 mix-blend-overlay">Highlight</h1>
                    </div>
                    <div className="mt-8 w-full h-auto rounded-lg bg-[#4c02e8] relative selection:bg-[#3cffd0]">
                        ...
                        <div className="w-full h-6 z-0"></div>
                        <h1 className="absolute z-0 bottom-10 -right-4 text-8xl font-black uppercase text-white transform -rotate-90 mix-blend-overlay">Favour</h1>
                    </div>
                </div>
