                ...
                <div className="flex flex-col md:grid md:grid-cols-4 gap-4 min-w-screen mt-4 mx-4 ">
                    ...
                    <div className="w-full h-40 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-gray-800 dark:via-gray-900 dark:to-black rounded-xl flex flex-col relative">
                        <div className="flex flex-col">
                            <p className="mt-4 ml-5 md:ml-4 text-2xl font-semibold">11038</p>
                    ...
                    <div className="w-full h-40 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-gray-800 dark:via-gray-900 dark:to-black rounded-xl flex flex-col relative">
                        ...
                        <div className="flex flex-row">
                            <p className="mt-10 ml-4 text-4xl font-semibold">280</p>
                            <p className="mt-14 ml-1 text-sm text-gray-500">小时</p>
                            <p className="mt-10 ml-1 text-4xl font-semibold">46</p>
                    ...
                    <div className="w-full h-40 md:h-56 flex flex-row md:flex-col bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-gray-800 dark:via-gray-900 dark:to-black rounded-xl">
                        ...
                        >
                            ...
                            <div className="absolute top-[70px] left-32 md:top-[100px] md:left-40 xl:top-[120px] xl:left-52 w-20 h-20 md:h-10 md:w-10 xl:h-14 xl:w-14 scale-50 rounded-full bg-gradient-to-r dark:from-blue-600 dark:to-violet-600 from-cyan-200 to-cyan-400 sm:scale-100"></div>
                            <motion.div
                        ...
                        <a className="text-sm mt-8 md:-mt-4 xl:mt-2 mr-8 md:mr-0 ml-0 md:ml-10 xl:ml-20 w-24 md:w-40 uppercase font-semibold"
                            ...
                            <div className="overflow-hidden">
                                <div className="flex">
                                    ...
                                    <div className="relative md:place-items-center z-0">
                                        ...
                                        <div className="h-28 w-28 p-6">
                                            <img className="h-24 w-24 rounded-md object-cover mt-2"
                    ...
                    <div className="w-full h-64 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-gray-800 dark:via-gray-900 dark:to-black rounded-xl md:-mt-68">
                        <div className="rounded-lg bg-light-map dark:invert-[.97] h-64 max-w-full bg-cover bg-center"></div>
                    </div>
                </div>
            </motion.div>
        </motion.body>
