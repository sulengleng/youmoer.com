            ...
            >
                <motion.div className="flex md:flex-row flex-col space-y-4 max-w-full">
                    ...
                    <div className="basis-1/3 lg:basis-3/7">
                        <div className="rounded-lg max-w-[90%] md:max-w-fit mx-auto">
                            <div className="drop-shadow-md rounded-lg bg-camera-white dark:bg-camera-black max-w-full h-56 bg-cover bg-center"></div>
                        </div>
