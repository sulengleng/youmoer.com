            ...
            >
                ...
                <div className="flex flex-col md:grid md:grid-cols-3 gap-6 min-w-screen w-[90%] md:w-[600px] lg:w-[850px] xl:w-[1000px] mx-auto my-8 ">
                    ...
                    <div className="w-full h-44 flex bg-light-board dark:bg-dark-board bg-cover border dark:border-none border-gray-100 drop-shadow rounded-2xl row-span-1">
                        <div className="group relative w-[70%] h-28">
                            <div className="absolute mx-auto place-self-center bg-white dark:bg-black rounded-lg group-hover:translate-y-4 group-hover:-rotate-3"></div>
                            <div className="absolute mx-auto place-self-center bg-white dark:bg-black rounded-lg group-hover:translate-y-4 group-hover:-rotate-3"></div>
                        </div>
                    </div>
