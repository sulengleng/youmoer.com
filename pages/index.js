            ...
            >
                <motion.div className="flex md:flex-row flex-col space-y-4 max-w-full">
                    ...
                    <div className="basis-1/3 lg:basis-3/7">
                        ...
                        <div className="relative flex flex-col bg-gradient-to-br mx-4 from-[#fdfbfb] to-[#ebedee] max-w-[90%] w-auto md:w-max md:max-w-fit h-32 mx-auto rounded-lg">
                            <p className="text-sm font-semibold top-4 left-4 absolute w-44">最近看什么？</p>
                            <div className="flex flex-row">
