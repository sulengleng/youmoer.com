                ...
                <motion.div className="flex md:flex-row flex-col space-y-4 max-w-full">
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="place-self-center -ml-4 pr-8 py-1 xl:pr-0 xl:-ml-0 xl:py-6 px-3 z-10">
                                          ...
                                          <span className="flex h-3 w-3">
                                            ...
                                            <div
                                                className="mt-1 block text-lg font-semibold leading-tight dark:text-white">十万嬉皮 <a className="text-sm ml-4 xl:ml-0 font-medium uppercase leading-3 tracking-wide text-gray-800 dark:text-gray-400">万能青年旅店</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="basis-1/3 lg:basis-3/7">
                        <div className="flex flex-col bg-gradient-to-br mx-4 from-[#fdfbfb] to-[#ebedee] dark:from-black dark:to-[#434343] max-w-[90%] w-auto md:w-max md:max-w-fit h-auto mx-auto rounded-lg">
                            ...
                            <div className="w-60 h-6 mx-auto my-4 xl:w-96 rounded-md drop-shadow-2xl bg-gray-700 border border-gray-800">
                    ...
                    <div className="basis-1/3 md:basis-2/7">
                        <div className="rounded-lg aspect-square md:mr-4 max-w-[90%] md:max-w-64 xl:max-w-full mx-auto mb-4 -pl-4">
                            <div className="drop-shadow-md rounded-lg bg-light-map dark:bg-dark-map h-80 max-w-full bg-cover bg-center"></div>
                        </div>
                        <motion.div
                            className="max-w-[90%] mx-auto md:max-w-64 xl:max-w-full mb-4 md:mr-4 flex bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-black dark:via-[#2e2e2e] dark:to-[#434343] rounded-lg drop-shadow-md overflow-hidden"
                        ...
                        <div className="map invert dark:invert-0 drop-shadow-md rounded-lg max-w-[90%] md:max-w-64 xl:max-w-full mx-auto">
                            <StrictMode>
                                <Notebook />
                            </StrictMode>
                        </div>
