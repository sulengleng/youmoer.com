            ...
            >
                <motion.div className="flex md:flex-row flex-col space-y-4 max-w-full">
                    ...
                    <div className="basis-1/3 md:basis-2/7">
                        <div className="rounded-lg aspect-square ml-0 md:-ml-4 xl:ml-0 md:mr-4 max-w-[90%] md:max-w-xs xl:max-w-full mx-auto mb-4">
                            <div className="drop-shadow-md rounded-lg bg-light-map dark:bg-dark-map h-80 max-w-full bg-cover bg-center"></div>
                        </div>
                        <motion.div
                            className="max-w-[90%] mx-auto ml-0 md:-ml-4 xl:ml-0 md:max-w-xs xl:max-w-full mb-4 md:mr-4 flex bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-black dark:via-[#2e2e2e] dark:to-[#434343] rounded-lg drop-shadow-md overflow-hidden"
