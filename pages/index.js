                ...
                <motion.div className="flex md:flex-row flex-col space-y-4 max-w-full">
                    ...
                    <div className="basis-1/3 lg:basis-3/7">
                        <div className="flex flex-col bg-gradient-to-br mx-4 from-[#fdfbfb] to-[#ebedee] dark:from-black dark:to-[#434343] max-w-[90%] w-auto md:w-max md:max-w-fit h-auto mx-auto rounded-lg">
                            <div className="flex">
                                <div className="bg-camera-left bg-cover rounded-3xl h-20 w-20 xl:h-28 xl:w-28 ml-10 mr-8 mt-6"></div>
                                ...
                                <div className="bg-camera-right bg-cover rounded-3xl h-20 w-20 xl:h-28 xl:w-28 mr-10 ml-8 mt-6"></div>
                            </div>
                            <div className="w-64 h-6 mx-auto my-4 xl:w-96 rounded-md drop-shadow-2xl bg-gray-700 border border-gray-800">
                    ...
                    <div className="basis-1/3 md:basis-2/7">
                        <div className="rounded-lg aspect-square md:mr-4 max-w-[90%] md:max-w-fit xl:max-w-full mx-auto mb-4">
                            <div className="drop-shadow-md rounded-lg bg-light-map dark:bg-dark-map h-80 max-w-full bg-cover bg-center"></div>
                        </div>
                        <motion.div
                            className="max-w-[90%] mx-auto md:max-w-fit xl:max-w-full mb-4 md:mr-4 flex bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] dark:from-black dark:via-[#2e2e2e] dark:to-[#434343] rounded-lg drop-shadow-md overflow-hidden"
                        ...
                        <div className="map invert dark:invert-0 drop-shadow-md rounded-lg max-w-[90%] md:max-w-fit xl:max-w-full mx-auto">
