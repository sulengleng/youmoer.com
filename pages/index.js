      ...
      <div className="pb-20">
        ...
        >
          ...
          <div class="snap-mandatory snap-x">
            <div class="hue-rotate-15 hover:filter-none max-w-[80%] mx-auto md:max-w-2xl flex justify-center bg-[#821c20] rounded-xl shadow-lg overflow-hidden snap-center lg:max-w-[60%]">
              <div class="md:flex">
