    ...
    <div className="pb-20">
      ...
      >
        ...
        <div class="snap-mandatory snap-x">
          <div class="max-w-[80%] mx-auto md:max-w-2xl flex justify-center bg-[#821c20] rounded-xl shadow-lg overflow-hidden snap-center">
            <div class="md:flex">
      ...
      <fieldset className="mx-auto max-w-[85%] md:max-w-[80%] flex rounded-xl shadow-lg overflow-hidden p-4 bg-[#171717]">
        <h3>看完网站，你觉得如何：&nbsp;</h3>
