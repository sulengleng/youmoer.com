                ...
                <div className="flex">
                    ...
                    <div className="relative md:place-items-center">
                        <div className="absolute items-center">
                            {isPlaying ? (
                                <PauseCircle size={48} className="opacity-50 pl-6" color="#f6f5f6" onClick={togglePlay}/>
                            ) : (
                                <PlayCircle size={48} className="opacity-50 pl-6" color="#f6f5f6" onClick={togglePlay}/>
                            )}
                        </div>
