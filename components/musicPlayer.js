        ...
        <div className="player pt-6">
            <div className="max-w-md mx-auto bg-gradient-to-r from-black via-[#041c0c] to-[#062a13] rounded-xl shadow-md overflow-hidden md:max-w-2xl">
                <div className="md:flex">
                    <div className="md:shrink-0 h-48 w-48 place-self-center">
                        <div className="absolute h-48 w-48 place-items-center">
                            {isPlaying ? (
                                <PauseCircle size={48} className="opacity-50 place-self-center"  color="#f6f5f6" onClick={togglePlay} />
                            ) : (
                                <PlayCircle size={48} className="opacity-50 place-self-center"  color="#f6f5f6" onClick={togglePlay} />
                            )}
                        </div>
                        <img className="h-20 w-full object-cover md:h-full md:aspect-square rounded-md pl-4" src="https://files.catbox.moe/9i0d2g.png"
                             alt="Music cover" />
                    </div>
                    <div className="p-8">
