            ...
            <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
                <div className="md:flex">
                    <div className="md:shrink-0">
                        <div className="absolute h-36 w-36 hover:bg-gray-500/80">
                            {isPlaying ? (
                                <PauseCircle size={76} className="opacity-50 place-items-center"  color="#f6f5f6" onClick={togglePlay} />
                            ) : (
                                <PlayCircle size={76} className="opacity-50 place-items-center"  color="#f6f5f6" onClick={togglePlay} />
                            )}
                        </div>
